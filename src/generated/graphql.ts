...
export type SubgraphPublishMutationVariables = Exact<{
  graph_id: Scalars['ID'];
  variant: Scalars['String'];
...
export type SubgraphPublishMutation = { __typename?: 'Mutation', service?: Maybe<{ __typename?: 'ServiceMutation', upsertImplementingServiceAndTriggerComposition?: Maybe<{ __typename?: 'CompositionAndUpsertResult', didUpdateGateway: boolean, serviceWasCreated: boolean, compositionConfig?: Maybe<{ __typename?: 'CompositionConfig', schemaHash: string }>, errors: Array<Maybe<{ __typename?: 'SchemaCompositionError', message: string, code?: Maybe<string> }>> }> }> };
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    SubgraphPublish(variables: SubgraphPublishMutationVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<SubgraphPublishMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<SubgraphPublishMutation>(SubgraphPublishDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'SubgraphPublish');
    }
  };
}
